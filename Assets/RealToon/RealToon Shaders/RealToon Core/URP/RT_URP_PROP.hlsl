...
#define _TessellationSmoothness							UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationSmoothness);
#define _TessellationTransition							UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationTransition);
#define _TessellationNear								UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationNear);
#define _TessellationFar								UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationFar);
#define _NorMapAsDis									UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _NorMapAsDis);
